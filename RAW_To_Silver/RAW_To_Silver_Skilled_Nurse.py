...
# FilesLocations
INPUT_FILE_PATH = "s3://healthcare-etoe-proj-raw-bucket/raw/transactions/Skilled_Nursing_Facility_Quality_Reporting_Program_Provider_Data_Oct2024.csv"
OUTPUT_DELTA_PATH = "s3://healthcare-etoe-proj-silver-bucket/transactions/Skilled_Nursing_Facility_Quality_Reporting_Program_Provider_Data_Oct2024.csv"
...
dynamic_df = gluecontext.create_dynamic_frame.from_options(
    ...
    transformation_ctx="bookmark_ctx_Skilled_NurFacility_Quality_Reporting_Program_Provider_Data" # Unique identifier for tracking this file's state
)
