...
# FilesLocations
INPUT_FILE_PATH = "s3://healthcare-etoe-proj-raw-bucket/raw/transactions/NH_QualityMsr_Claims_Oct2024.csv"
OUTPUT_DELTA_PATH = "s3://healthcare-etoe-proj-silver-bucket/transactions/NH_QualityMsr_Claims_Oct2024/"
...
dynamic_df = gluecontext.create_dynamic_frame.from_options(
    ...
    transformation_ctx="bookmark_ctx_QualityMsr_Claims_info" # Unique identifier for tracking this file's state
)
